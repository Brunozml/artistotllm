...
# Download NLTK stopwords if they don't exist
try:
...
def preprocess_text(text: str) -> str:
    """
    Preprocess text by lowercasing and removing stop words
    """
...
def ngram_similarity(text1: str, text2: str, n: int = 2) -> Tuple[float, Dict]:
    ...
    # Get n-grams from processed text
    ngrams1 = get_ngrams(text1_processed, n)
    ngrams2 = get_ngrams(text2_processed, n)
